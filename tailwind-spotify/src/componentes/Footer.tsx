...
export function Footer() {
    return (<footer className="bg-zinc-800 border-t border-zinc-700 px-6 py-4 flex items-center justify-between">
        <div className='flex items-center gap-3'>
            <Image src="/album.jpg" width={48} height={48} alt="Capa do Trigger Worlds" />
            <div className='flex flex-col'>
                <strong className='font-normal'>Rogs</strong>
        ...
        <div className='flex flex-col items-center gap-2'>
            ...
            <div className='flex items-center gap-2'>
                <span className='text-rs text-zinc-400'>0:31</span>
                <div className='h-1 rounded-full w-96 bg-zinc-600'>
                    <div className='bg-zinc-200 w-40 h-1 rounded-full'></div>
                </div>
                <span className='text-rs text-zinc-400'>2:14</span>
            </div>
        </div>
